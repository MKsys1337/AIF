...
Diese Spezifikation und die zugehörigen Referenzimplementierungen werden unter der **AGPL-3.0-or-later** (GNU Affero General Public License v3.0 oder höher) veröffentlicht. Eine kommerzielle Lizenz ist separat erhältlich.

Copyright (C) 2026 Markus Köplin. Alle Rechte vorbehalten.

Kontributions-Vorschläge für die Spezifikation können über das GitHub-Repository [github.com/MKsys1337/AIF](https://github.com/MKsys1337/AIF) eingereicht werden.
